...
class Company final :
 ...
 public:
  ...
  public:
  // optional bool COFEA = 5;
  bool has_cofea() const;
  void clear_cofea() ;
  bool cofea() const;
  void set_cofea(bool value);

  private:
  bool _internal_cofea() const;
  void _internal_set_cofea(bool value);
...
// optional bool COFEA = 5;
inline bool Company::has_cofea() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline void Company::clear_cofea() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.cofea_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Company::cofea() const {
  // @@protoc_insertion_point(field_get:Company.COFEA)
  return _internal_cofea();
}
inline void Company::set_cofea(bool value) {
  _internal_set_cofea(value);
  // @@protoc_insertion_point(field_set:Company.COFEA)
}
inline bool Company::_internal_cofea() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.cofea_;
}
inline void Company::_internal_set_cofea(bool value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.cofea_ = value;
}
